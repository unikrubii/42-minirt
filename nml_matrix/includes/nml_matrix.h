...
/*   Updated: 2023/05/04 11:05:46 by nnakarac         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define NML_MIN_COEF 0.0000000000000000001
...
float			nml_vect_norm(t_nml_mat *m);

int				nml_vect_normalize_r(t_nml_mat *m);

t_nml_mat		*nml_vect_normalize(t_nml_mat *m);
