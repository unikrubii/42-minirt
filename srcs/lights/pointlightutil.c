...
/*   Updated: 2023/06/24 23:52:25 by nnakarac         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	t_objbase *obj, t_objbase *cur_obj, t_scene *scn)
{
	...
	scn->tmp_light_dir_bfr_nrm = v_light_dir;
	scn->tmp_light_dist = nml_vect_norm(scn->tmp_light_dir_bfr_nrm);
